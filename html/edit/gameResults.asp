<%
    ...
    Dim sMsg, sErr, sMDB, sConn, vID, vGameID,vSeasonName,vHomeTeamName,vAwayTeamName,vLocationName,vGameDate,vGameTime,vFirstPeriodHomeShots
    Dim vFirstPeriodAwayShots,vFirstPeriodHomeGoals,vFirstPeriodAwayGoals,vSecondPeriodHomeShots,vSecondPeriodAwayShots,vSecondPeriodHomeGoals
    Dim vSecondPeriodAwayGoals,vThirdPeriodHomeShots,vThirdPeriodAwayShots,vThirdPeriodHomeGoals,vThirdPeriodAwayGoals,vOvertimeHomeShots
    Dim vOvertimeAwayShots,vOvertimeHomeGoals,vOvertimeAwayGoals,vAttendance,vReferee1,vReferee2,vScoreKeeper,vNotes,vPreviewTitle,vPreview
    Dim vRecapTitle,vRecap,vScored
    Dim lastGameID
...
%>
<FORM method="post" action="gameResults.asp?ID=<%=vID%>" id="frm_Games" name="frm_Games">
...
If vID > 2 Then
%>
<a href="gameResults.asp?ID=2">&lt;&lt; First</a>
&nbsp;&nbsp;&nbsp;<a href="gameResults.asp?ID=<%= vID - 1 %>">&lt; Prev</a>
<%
Else
%>
&lt;&lt; First&nbsp;&nbsp;&nbsp;&lt; Prev
...
%>
&nbsp;&nbsp;&nbsp;<a href="gameResults.asp?ID=<%= vID + 1 %>">Next &gt;</a>
&nbsp;&nbsp;&nbsp;<a href="gameResults.asp?ID=<%= lastGameId %>">Last &gt;&gt;</a>
<%
Else
%>
&nbsp;&nbsp;&nbsp;Next &gt;&nbsp;&nbsp;&nbsp;Last &gt;&gt;
...
<!-- End Navigation -->
        <tr valign="top">
            ...
            <td width="260"><%= vSeasonName %></td>
        </tr>

        <tr valign="top">
            <td width="180">Home Team</td>
            <td width="260"><%= vHomeTeamName %></td>
        </tr>

        <tr valign="top">
            <td width="180">Away Team</td>
            <td width="260"><%= vAwayTeamName %></td>
        </tr>

        <tr valign="top">
            <td width="180">Location</td>
            <td width="260"><%= vLocationName %></td>
        </tr>
...
<%
    ...
    Function RetrieveRecord(vID)
        ...
        sSQL = "SELECT g.*, s.SeasonName as seasonName, awayTeam.TeamName as awayTeamName, homeTeam.TeamName as homeTeamName, l.LocationName as locationName FROM (((tbl_Games g inner join tbl_Seasons s on g.SeasonID = s.SeasonID) inner join tbl_Teams awayTeam on g.AwayTeamID = awayTeam.TeamID) inner join tbl_Teams homeTeam on g.HomeTeamID = homeTeam.TeamID) inner join tbl_Locations l on g.LocationID = l.LocationID WHERE GameID = " & sFilter
        Set rsDataTable = cnnDBS.Execute(sSQL)
        ...
        If Not rsDataTable.BOF And Not rsDataTable.EOF Then
            ...
            vHomeTeamName=rsDataTable("homeTeamName")
            vAwayTeamName=rsDataTable("awayTeamName")
            vLocationName=rsDataTable("locationName")
